				...
				>
					<div class="card-body {act.rating_act ? 'text-black' : ''}">
						<div class="columns-2">
							...
							<span>
								<p class="card-text break-inside-avoid-column">
							...
							<div class="pl-9">
								<div class="flex items-center justify-items-end pt-4">
								...
								<div class="flex items-center">
									<p class="font-bold pt-1 text-lg text-right">
										{#if act.rating_drink}
											{act.rating_drink}
										{:else}
											Not Rated
									...
									>
										...
										<mask id="path-3-inside-1_1358_321" fill="white">
											<path
												d="M5 9.28571C5 9.02012 5 8.88733 5.02507 8.77748C5.11055 8.40298 5.40298 8.11055 5.77748 8.02507C5.88733 8 6.02012 8 6.28571 8H17.7143C17.9799 8 18.1127 8 18.2225 8.02507C18.597 8.11055 18.8895 8.40298 18.9749 8.77748C19 8.88733 19 9.02012 19 9.28571V10C19 10.9288 19 11.3933 18.9487 11.7832C18.5942 14.4756 16.4756 16.5942 13.7832 16.9487C13.3933 17 12.9288 17 12 17C11.0712 17 10.6067 17 10.2168 16.9487C7.52444 16.5942 5.40579 14.4756 5.05133 11.7832C5 11.3933 5 10.9288 5 10V9.28571Z"
											/>
										</mask>
										<path
											d="M5 9.28571C5 9.02012 5 8.88733 5.02507 8.77748C5.11055 8.40298 5.40298 8.11055 5.77748 8.02507C5.88733 8 6.02012 8 6.28571 8H17.7143C17.9799 8 18.1127 8 18.2225 8.02507C18.597 8.11055 18.8895 8.40298 18.9749 8.77748C19 8.88733 19 9.02012 19 9.28571V10C19 10.9288 19 11.3933 18.9487 11.7832C18.5942 14.4756 16.4756 16.5942 13.7832 16.9487C13.3933 17 12.9288 17 12 17C11.0712 17 10.6067 17 10.2168 16.9487C7.52444 16.5942 5.40579 14.4756 5.05133 11.7832C5 11.3933 5 10.9288 5 10V9.28571Z"
											...
											mask="url(#path-3-inside-1_1358_321)"
										/>
										<path
											d="M11.0385 11.7253C10.8868 12.2563 11.1942 12.8098 11.7253 12.9615C12.2563 13.1132 12.8098 12.8058 12.9615 12.2747L11.0385 11.7253ZM13.7305 5.9432L14.692 6.21792L13.7305 5.9432ZM14.9108 4.63569L14.5394 3.70721L14.5394 3.70721L14.9108 4.63569ZM14.0845 5.07626L14.8268 5.74632L14.0845 5.07626ZM12.9615 12.2747L14.692 6.21792L12.769 5.66848L11.0385 11.7253L12.9615 12.2747ZM15.2822 5.56416L19.3714 3.92848L18.6286 2.07152L14.5394 3.70721L15.2822 5.56416ZM14.692 6.21792C14.7629 5.97002 14.7995 5.84514 14.8328 5.75786C14.8593 5.68854 14.8599 5.70964 14.8268 5.74632L13.3422 4.40619C12.9947 4.79109 12.8743 5.29982 12.769 5.66848L14.692 6.21792ZM14.5394 3.70721C14.1834 3.8496 13.6896 4.0213 13.3422 4.40619L14.8268 5.74632C14.7937 5.783 14.7726 5.78461 14.8389 5.75117C14.9223 5.70905 15.0428 5.65992 15.2822 5.56416L14.5394 3.70721Z"
											fill="#33363F"
										/>
									</svg>
								</div>
